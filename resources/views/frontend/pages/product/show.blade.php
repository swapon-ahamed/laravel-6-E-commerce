        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            ...
            <div class="product-item carousel-item {{ $i == 1 ? 'active':'' }}">
              <img width="100"class="d-block w-100" src="{!! asset('images/products/'.$iamge->image) !!}" alt="First slide">
            </div>
            @php  $i++; @endphp
            @endforeach
          </div>
        ...
        <div class="col-md-8">
            <div class="widget">
              ...
              <h3>{{ $product->price }} Taka 
                <span class="badge badge-primary"> {{ $product->quantity < 1 ? "Out of stock" : $product->quantity ." Item in stock" }}</span>
              </h3>
               <hr>
